...
import sbsdk.talentcard.bsnsdk.client.fabric.service.ChainCodeService;
...
import sbsdk.talentcard.bsnsdk.entity.req.fabric.*;
...
//	}
    ...
    public void userRegister() {
    	...
    	//用户注册
    	try {
    		//httpService.post  设置参数，发送请求，这个封装了很多次

package sbsdk.talentcard.bsnsdk.util.sm2;
...
public class SM2SignVerUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] publicBytes = Base64.getDecoder().decode(base64String);
        ...
        System.out.println(Base64.getEncoder().encodeToString(bce2.getEncoded()));
        ...
        String prvString =
                "MIGTAgEAMBMGByqGSM49AgEGCCqBHM9VAYItBHkwdwIBAQQgRbYy4qWCVTNkWHsk" +
                        ...
                        "M8E8TCxW";
        byte[] prvBytes22 = Base64.getDecoder().decode(prvString);
